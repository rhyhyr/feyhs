    ...
    <div className={getScreenClass("s-knowledge")} id="s-knowledge">
      <div className="topbar">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "7px" }}>
          ...
          <span style={{ fontSize: "13px", color: "var(--c-t2)" }}>
            비자 & 체류 채널
          </span>
        </div>
      </div>
      <div className="scroll-area">
        ...
        >
          <span
            className="tag"
            style={{ background: "var(--c-purple-l)", color: "var(--c-purple)" }}
          >
            #D-2
          </span>
          <span
        ...
        <div className="kd-block-text">
          D-2 비자 연장에 필요한 서류입니다. 출입국관리사무소 방문 신청 또는
          Hi Korea 온라인 신청 모두 가능합니다.
        </div>
        ...
        <div
          className="related-q"
          onClick={() => showToast("관련 질문을 불러옵니다")}
        >
          비자 연장 신청 기간이 언제예요?
