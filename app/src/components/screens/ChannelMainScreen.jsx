  ...
  return (
    <div className={getScreenClass("s-channel-main")} id="s-channel-main">
      ...
      <div className="ch-tabs">
        <div className="ch-tab" onClick={() => navigate("s-visa")}>
          💬 채팅
        </div>
      ...
      >
        <div className="k-card" onClick={() => navigate("s-knowledge")}>
          ...
          <div className="k-card-foot">
            ...
            <span style={{ fontSize: "11px", color: "var(--c-t3)" }}>
              3일 전
            </span>
          </div>
        </div>
        <div className="k-card" onClick={() => navigate("s-knowledge")}>
          <div className="k-card-body">
            ...
            <div className="k-preview">
              만료일 4개월 전부터 신청 가능합니다. 늦어도 만료 1개월 전에는...
            </div>
          </div>
          <div className="k-card-foot">
            <div style={{ display: "flex", gap: "5px" }}>
        ...
        <div className="k-card" onClick={() => navigate("s-knowledge")}>
          <div className="k-card-body">
            <div className="k-q">
              Hi Korea에서 온라인 신청이 가능한가요?
            </div>
            <div className="k-preview">
              네, Hi Korea(www.hikorea.go.kr)에서 온라인으로 비자 연장 신청이
              가능합니다...
            </div>
          </div>
          <div className="k-card-foot">
